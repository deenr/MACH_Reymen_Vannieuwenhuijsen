...
if __name__ == '__main__':
    ...
    theta1 = utils.trainLinearReg(linearRegCostFunction, X_train, y_train, lambda_=0.2)
    theta2, _ = grad_w_lambda.gradientDescentMulti(X_train, y_train, np.zeros(X_train.shape[1]), 0.03, 200, 0)
    print(theta1)
    print(utils.calculateR2(X_test.dot(theta1), y_test))
    print(theta2)
    print(utils.calculateR2(X_test.dot(theta2), y_test))
